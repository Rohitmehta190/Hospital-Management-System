...
const DoctorForm = ({ doctor, onSave, onCancel, loading }) => {
  const [formData, setFormData] = useState({
    user_id: 1, // This should come from authentication - will be updated in parent
    ...
    availability: doctor?.availability || 'full-time'
  });
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // In a real app, you'd get the user_id from the authenticated user
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  {doctor ? 'Update doctor information' : 'Fill in the doctor details below'}
                </p>
              </div>
            </div>
            <button
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="appearance-none relative block w-full pl-10 pr-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-colors"
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={3}
                className="appearance-none relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-colors resize-none"
